...
const Register = () => {
    ...
    const {sighUp, setUser, profileUpdate} = useAuth()
                ...
                <div className="relative shrink-0 lg:w-1/2 lg:h-[500px] bg-base-100 md:px-0 lg:px-10">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="form-control mt-6">
                            <button type="submit" className="text-white animation-hover py-3 rounded">Sign Up</button>
                        </div>
                        <div className="mt-3">
                            {
                    ...
                    <div>
                        <button onClick={() => setHidden(!hidden)} className="absolute bottom-[130px] lg:bottom-[105px] right-[15px] lg:right-[50px] hover:bg-slate-400/75 duration-[400ms] ease-in-out text-[18px] p-[10px] rounded-full">{hidden ? <FaRegEyeSlash ></FaRegEyeSlash> : <FaRegEye></FaRegEye>}</button>
                    </div>
                </div>
